...
namespace ow.Framework.Game.Storage
{
    public class EquipableGearStorage : BaseStorage
    {
        ...
        public ItemStorage Talisman => this[EquippedGearSlot.Talisman];
        ...
        public EquipableGearStorage(IEnumerable<ItemModel> values) : base(values, Defines.EquipableFashionStorageMaxCapacity)
        {
        }
    }
}