...
{
    public abstract class BaseDimensionMember<TDimension, TSession>
        where TDimension : BaseDimension<TSession>
        where TSession : SyncSession
    {
        protected readonly TDimension Dimension;
        ...
        public void BroadcastAsync(CharacterLevelSet value) =>
            Dimension.BroadcastAsync(ClientOpcode.CharacterLevelSet, (PacketWriter writer) =>
            {
                writer.Write(value.Character);
        ...
        public void BroadcastAsync(CharacterGestureDo value) =>
            Dimension.BroadcastAsync(ClientOpcode.GestureDo, (PacketWriter writer) =>
            {
                writer.Write(value.Character);
        ...
        public void BroadcastAsync(MovementMoveRequest request) =>
            Dimension.BroadcastAsync(ClientOpcode.MovementMove, (PacketWriter writer) =>
            {
                writer.Write(request.Character);
                writer.Write(request.Unknown1);
                writer.WriteVector3(request.Position);
        ...
        public void BroadcastAsync(MovementStopRequest request) =>
            Dimension.BroadcastAsync(ClientOpcode.MovementStop, (PacketWriter writer) =>
            {
                writer.Write(request.Character);
                writer.Write(request.Unknown1);
                writer.WriteVector3(request.Position);
        ...
        public void BroadcastAsync(CharacterLoopMotionEndResponse value) =>
            Dimension.BroadcastAsync(ClientOpcode.MovementLoopMotionEnd, (PacketWriter writer) =>
                writer.Write(value.Character));

        #endregion Broadcast Movement Packet

        protected BaseDimensionMember(TSession session, TDimension dimension) =>
