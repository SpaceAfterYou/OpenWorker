...
namespace SetupDatabase.Migrations
{
    ...
    [Migration("20201208151954_12_8_20")]
    partial class _12_8_20
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.AccouintPosts.AccountPostModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.Accounts.AccountModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.CharacterPosts.CharacterPostModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.Characters.CharacterModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.Guilds.GuildModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.Storages.ItemModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.AccouintPosts.AccountPostModel", b =>
                {
                    b.HasOne("Core.Systems.DatabaseSystem.Accounts.AccountModel", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Systems.DatabaseSystem.CharacterPosts.CharacterPostModel", b =>
                {
                    b.HasOne("Core.Systems.DatabaseSystem.Characters.CharacterModel", "Character")
                        .WithMany()
