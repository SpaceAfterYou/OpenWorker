...
public sealed class BatchManager(MazeResourceProvider mazes, DistrictResourceProvider districts)
{
    ...
    public bool TryGetAndCache(short world, [MaybeNullWhen(false)] out VBatchFile file, BatchType target)
    {
        return TryGetAndCache(world, out file, out var type) && type == target;
    }
