...
public readonly struct PartyRecruitApplyInfoRequest(BinaryReader reader) : IRequestHotspotMessage, IWritableData
{
    ...
    public ActorValue Recruit { get; init; }

    public void Write(BinaryWriter writer)
    {
        writer.Write(Recruit);
    }
}
