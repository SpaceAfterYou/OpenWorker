...
namespace GateService.Systems.GameSystem.Extensions
{
    public static class WriterPacketExtension
    {
        public static void Write(this WriterPacket writer, Character value)
        {
        ...
        public static void Write(this WriterPacket writer, GateEnterResultType value) =>
            writer.Write((byte)value);

        private static void WriteCharacterMainData(this WriterPacket writer, Character value)
        {
        ...
        private static void WriteCharacterWeaponData(this WriterPacket writer, Character value)
        {
        ...
        private static void WriteCharacterFashionData(this WriterPacket writer, Character value)
        {
        ...
        private static void WriteCharacterMetaData(this WriterPacket writer, Character value)
        {
        ...
        private static void Write(this WriterPacket writer, Appearance value)
        {
        ...
        private static void Write(this WriterPacket writer, Hair hair)
        {
            writer.Write(hair.Style);
            writer.Write(hair.Color);
        }

        public static void Write(this WriterPacket writer, Place value)
        {
