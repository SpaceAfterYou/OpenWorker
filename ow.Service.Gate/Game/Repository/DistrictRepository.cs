...
namespace ow.Service.Gate.Game.Repository
{
    public sealed class DistrictRepository : Dictionary<ushort, DistrictRepository.Entity>
    {
        ...
        public DistrictRepository(IConfiguration configuration, GateInstance instance) : base(GetEntities(configuration, instance))
        {
        }

        private static IEnumerable<KeyValuePair<ushort, Entity>> GetEntities(IConfiguration configuration, GateInstance instance) => configuration
